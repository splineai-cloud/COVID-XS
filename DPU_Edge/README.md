...
```
Create a Bcuket with name 'covidxs' by running the follwing CLI:
...
The above step will create the zip file for uploading to create new Lambda function. To Create a new Lambda function from AWS Lambda Console the steps are given below: 
```
